...
<html>
    ...
    <body class="w3-light-grey">
        <!-- Top container -->
        <div class=" w3-bar w3-top w3-black w3-large airplane_frame"  style="z-index:4">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="w3-row-padding w3-margin-bottom">
                ...
                <div id="model_div" class="model_div_img">
                    <img id="airplane_svg" src="../pics/airplane_svg.png" alt="">
                    <img id="flat_svg" src="../pics/flap_svg.png" alt="">
                </div>
